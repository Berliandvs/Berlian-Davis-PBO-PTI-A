...
public class Main {
    public static void main(String[] args) {
        ...
        // Objek kedua menggunakan constructor dengan parameter namaBuku
        Buku buku2 = new Buku("History PTI");

        // Objek ketiga menggunakan constructor dengan parameter namaBuku, jenisBuku, dan halamanBuku
        Buku buku3 = new Buku("History PTI", "Pendidikan", "500");

        //NO 7 (Panggil method overloading yang telah kalian buat dari 1 objek saja)
        // Memanggil method overloading
        buku3.simpanBuku("Rak nomor 3");
        buku3.simpanBuku(5);
        buku3.simpanBuku("Rak nomor 3", 5);
